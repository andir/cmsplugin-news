...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_news_news', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imagestore.Album'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.album'
        db.delete_column('cmsplugin_news_news', 'album_id')
    ...
    models = {
        ...
        'cmsplugin_news.news': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['imagestore.Album']", 'null': 'True'}),
